...
<div class="section">
    <div class="row">
        ...
        <h2 class="font-weight-light text-black text-center">Great Misal Points!!</h2>
        ...
        <div class=" text-center m-0 ">
            ...
            <div class="col text-center"><br><br>
                <a href="<?= base_url('MainC/All/foodstuff') ?>" style="color:black;" class="btn btn-outline-default btn-round btn-white btn-lg">View All Dishes</a>
            </div>
        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="text-center">
                                            ...
                                            <div class="card-body ">
                                                <h5 class="card-title display-4 title text-dark" style="font-size: 25px; margin-bottom: 0px !important;"><?= $sec1[$i]->name ?></h5>
                                ...
                                <?php for ($i = 0; $i < count($sec2); $i++) : ?>
                                    <?php if ($sec2[$i]->active == 1) : ?>
                                        <div class="carousel-item <?php if ($i == 0) {echo "active";} ?>">
                                            <img class="d-block fix_carousel_img" src="<?= base_url('assets/images/') . $sec2[$i]->img ?>" alt="Food Slide">
