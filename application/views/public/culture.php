    ...
    <div class="section">
      <div class="container">
        ...
        <div class="col text-center">
          <a href="<?= base_url('MainC/All/culture') ?>" style="color:black;" class="btn btn-outline-default btn-round btn-white btn-lg">View Our Culture</a>
        </div>
      </div>
    </div>
  </div>
              ...
              <div class="carousel-item active"><br><br>
                <div class="row welcome-grids">
                  ...
                  <div class="col-lg-6 mt-lg-0 mt-5 welcome-grid3 d-none d-lg-block">
                    <div class="position mx-2 my-2 mb-5">
