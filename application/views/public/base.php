    ...
    <nav class="navbar navbar-transparent navbar-color-on-scroll fixed-top navbar-expand-lg" color-on-scroll="100" id="sectionsNav">
        <div class="navbar-translate">
            <span style="text-transform:uppercase;">
                <a class="navbar-brand" href="<?= base_url('MainC/') ?>"><i class="fa fa-plane"></i>
                    Nashik Tourism</a><br><a class="navbar-brand" style="padding-left:75px !important; font-size:15px !important;" href="https://nmc.gov.in/" target="_blank" title="Nashik Municipal Corporation">BY NMC</a></span>
            ...
            <ul class="navbar-nav ml-auto">
                <?php for ($i = 0; $i < 5; $i++) : ?>
                    <?php if ($Page['navbar'][$i]->active) : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= (!$Page['navbar'][$i]->outsidelink) ? base_url($Page['navbar'][$i]->link) : $Page['navbar'][$i]->link  ?>" target="_<?= $Page['navbar'][$i]->target ?>">
                                <?= $Page['navbar'][$i]->name ?>
                            </a>
                        </li>
                    <?php endif ?>
                ...
                <li class="dropdown nav-item">
                    ...
                    <div class="dropdown-menu dropdown-with-icons">
                        <?php for ($i = 5; $i < count($Page['navbar']); $i++) : ?>
                            <?php if ($Page['navbar'][$i]->active) : ?>
                                <a class="dropdown-item" href="<?= (!$Page['navbar'][$i]->outsidelink) ? base_url($Page['navbar'][$i]->link) : $Page['navbar'][$i]->link  ?>" target="_
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <br>
                    <a href="https://www.youtube.com/embed/569lQejCuFQ?start=0&autoplay=1" target="_blank" class="btn btn-danger btn-raised btn-lg">
            ...
            <div class="container">
                ...
                <div class="sharing-area text-center">
                    <div class="row justify-content-center">
                        <h3 style="font-weight:400; text-transform:uppercase; font-size: 23px;">Connect with Us</h3>
                    </div>
                    <a id="twitter" class="btn btn-raised btn-twitter" data-toggle="modal" href="javascript:void(0)" onclick="openLoginModal();">
                    ...
                    <a id="github" class="btn btn-raised btn-github" data-toggle="modal" href="javascript:void(0)" onclick="openRegisterModal();">
                                    ...
                                    <div class="box">
                                        <div class="content">
                                            ...
                                            <div class="form loginBox">
                                                <form method="post" id="Contact" action="<?= base_url('MainC/Contact') ?>" accept-charset="UTF-8">
                                                    <?= form_open() ?>
                                                    <input id="name" class="form-control" type="text" autocomplete="off" placeholder="Name" name="name">
                                                    <input id="email" class="form-control" autocomplete="off" type="text" placeholder="Email" name="email">
                                                    <input id="msg" class="form-control" type="text" autocomplete="off" placeholder="Message" name="msg"></input>
                                        ...
                                        <div class="box">
                                            <div class="content registerBox" style="display:none;">
                                                <div class="form">
                                                    <form method="post" id="Feedback"  data-remote="true" action="<?= base_url('MainC/Feedback') ?>" accept-charset="UTF-8">
                                                        <?= form_open() ?>
                                                        <input id="fname" class="form-control" type="text" autocomplete="off" placeholder="Name" name="name">
                                                        <input id="email" class="form-control" autocomplete="off" type="text" placeholder="Email" name="email">
                                                        <input id="fmsg" class="form-control" type="text" autocomplete="off" placeholder="Message" name="msg">
                                                        <input class="btn btn-register" type="submit" value="Submit" name="commit">
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
