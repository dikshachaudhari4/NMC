...
<div class="site-section" style="font-family: verdana;">
    ...
    <div class="container">
            ...
            <?php for ($i=0; $i < count($sec1) ; $i++): ?>
                ...
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <a href="<?= base_url('MainC/Places/'.$sec1[$i]->name) ?>" class="unit-1 text-center">
                        <div class="">
                        <img src="<?= base_url('assets/images/') . $sec1[$i]->img ?>"  alt="Image" class="img-fluid same_img"></div>
        ...
        <div class="col text-center"><br><br>
            <a href="<?= base_url('MainC/All/destination') ?>" style="color:black;" class="btn btn-outline-default btn-round btn-white btn-lg">View All Places</a>
        </div>
      </div>
</div>
...
<div class="container">
    <div class="container-fluid text-center">
        ...
        <div class="col text-center">
           <a href="<?= base_url('MainC/All/destination') ?>" style="color:black;" class="btn btn-outline-default btn-round btn-white btn-lg" target="_self">View All Places</a>
        </div>
    </div>
</div>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block fix_carousel_img" src="<?= base_url('assets/images/') . $sec6[0]->img ?>" alt="First slide">
                                    ...
                                    <?php for ($i=1; $i < count($sec6) ; $i++): ?>
                                        ...
                                        <div class="carousel-item">
                                            <img class="d-block fix_carousel_img" src="<?= base_url('assets/images/') . $sec6[$i]->img ?>" alt="Second slide">
                                            <div class="carousel-caption d-none d-md-block">
                                                <h4>
