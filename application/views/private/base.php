...
<head>
  ...
  <title>Nashik Tourism &mdash; <?= $Page['title'] ?></title>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $(".del").on("click", function() {
        ...
        console.log(rowCount ,sec_no);
        if (rowCount <= sec_no && k != 'popup_data' && k != "contact" && k != "feedback") {
          ...
          var hide = $(this).closest('tr').find(":hidden");
          var id = hide.attr("value");
          console.log("Inside in the else")
          var r = confirm("Do you want to Delete this?")
          if (r == true)
            window.location = url + "UserC/Remove/" + k + "/" + id;
          else
