                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control textarea" name="Descripition" id="Descripition" placeholder="Oh ... you want to add description related to your content...."></textarea>
                            </div>
                        </div>
                    </div>
                <?php endif ?>
                ...
                <?php if ($this->db->field_exists("map_url", $k)) : ?>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <label>Map Url : </label>
            <textarea class="form-control textarea" name="map_url" id="map_url" placeholder="Here you can add location url of place..."></textarea>
                            </div>
                        </div>
                    </div>
                <?php endif ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" name="main_category" style="padding: 5px !important;">
                    ...
                    <?php if ($this->db->field_exists("main_category", $k)) : ?>
                        <div class="row">
                            <div class="col-md-6 pr-1">
                                <div class="form-group">
                                    <label>Select the category:</label>
                                    <select class="form-control form-control-sm" name="main_category" id="main_category" style="padding: 5px !important;">                                  
                                    <option>Tourist</option>
                                    <option>Food</option>
                                    <option>Cultural</option>
                                     </select>
