       ...
       <?php endif ?>
           ...
           <tbody>
             ...
             <tr id="orderby_<?=$d->id?>">
               ...
               <?php if ($k == strtolower('Contact') || $k == strtolower('Feedback')): ?>
                ...
                <?php endif?>
                   ...
                   <?php if ($this->db->field_exists("id", $k)): ?>
                          <td class="flex" width="10%">
                            <button type="button" class="del btn btn-danger btn-round btn-md ">Delete <?= $k ?>
                          </td>
                  <?php endif?>
         ...
         <table class="table " id="change">
           ...
           <tbody>
             ...
             <tr>
               ...
               <?php if ($this->db->field_exists("verified", $k)): ?>
